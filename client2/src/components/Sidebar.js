...
const Sidebar = () => {
    ...
    return (
        <div className='flex flex-col w-full h-[100vh] shadow bg-blue-300 px-3 items-center'>
            <ProfileCard />
            <div className='flex flex-col bg-white w-full mt-3 rounded-md overflow-y-scroll custom-scrollbar overflow-x-clip overflow-y-clip scrollbar-none'>
